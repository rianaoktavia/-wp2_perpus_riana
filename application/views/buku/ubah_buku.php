...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <?php } ?>
            <?= $this->session->flashdata('pesan'); ?>
            <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#ubahBuku"><i class="fas fa-file-alt"></i> Buku Baru</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <picture>
                                    ...
                                    <img src="<?= base_url('assets/img/upload/') . $b['image']; ?>" class="img-fluid img-thumbnail" alt="<?= $b['judul_buku']; ?>">
                                </picture>
                            </td>
                            <td>
...
<div class="modal fade" id="ubahBuku" tabindex="-1" role="dialog" aria-labelledby="ubahBukuLabel" ariahidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ubahBukuLabel">Ubah Buku</h5>
            ...
            <form action="<?= base_url('buku/ubahBuku'); ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user" id="judul_buku" value="<?= $buku['judul_buku']; ?> name=" judul_buku" placeholder="Masukkan Judul Buku">
                    </div>
                    <div class="form-group">
