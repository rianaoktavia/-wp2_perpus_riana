                ...
                <tbody>
                    ...
                    foreach ($buku as $b) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('buku/ubahBuku/') . $b['id']; ?>" data-toggle="modal" data-target="#ubahBuku" class="badge badge-info"><i class="fas fa-edit"></i> Ubah</a>
...
<!-- End of Main Content -->
<!-- Modal Ubah buku -->
<div class="modal" id="ubahBuku">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="bukuBaruModalLabel">Ubah Buku</h5>
            ...
            <form action="<?= base_url('buku'); ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user" id="judul_buku" value="<?= $b['judul_buku']; ?>" name="judul_buku" placeholder="Masukkan Judul Buku">
                    </div>
                    <div class="form-group">
